...
/*    */     try {
/* 24 */       Constructor<?> con = ClassWrapper.NMS_NBTTAGLONG.getClazz().getDeclaredConstructor(new Class[] { long.class });
...
/* 37 */       return Long.valueOf(obj.toString().replace("L", ""));
